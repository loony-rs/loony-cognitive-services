...
pub struct RetrieveTranscriptResponse {
    ...
    pub translations:
        Option<::std::collections::HashMap<String, Vec<crate::batch::models::TranslationSentence>>>,
...
impl RetrieveTranscriptResponse {
    pub fn new(
        format: String,
        job: crate::batch::models::JobInfo,
        metadata: crate::batch::models::RecognitionMetadata,
        results: Vec<crate::batch::models::RecognitionResult>,
