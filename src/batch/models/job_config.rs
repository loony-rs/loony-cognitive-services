...
pub struct JobConfig {
    ...
    #[serde(
        rename = "language_identification_config",
        skip_serializing_if = "Option::is_none"
    )]
    pub language_identification_config:
        Option<Box<crate::batch::models::LanguageIdentificationConfig>>,
    #[serde(
        rename = "summarization_config",
        skip_serializing_if = "Option::is_none"
    )]
    pub summarization_config: Option<Box<crate::batch::models::SummarizationConfig>>,
    #[serde(
        rename = "sentiment_analysis_config",
        skip_serializing_if = "Option::is_none"
    )]
