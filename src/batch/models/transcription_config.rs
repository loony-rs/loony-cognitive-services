...
pub struct TranscriptionConfig {
    ...
    pub additional_vocab:
        Option<Vec<crate::batch::models::TranscriptionConfigAdditionalVocabInner>>,
    #[serde(
        rename = "punctuation_overrides",
        skip_serializing_if = "Option::is_none"
    )]
    pub punctuation_overrides:
        Option<Box<crate::batch::models::TranscriptionConfigPunctuationOverrides>>,
    ...
    #[serde(
        rename = "channel_diarization_labels",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    pub speaker_diarization_config:
        Option<Box<crate::batch::models::TranscriptionConfigSpeakerDiarizationConfig>>,
}
